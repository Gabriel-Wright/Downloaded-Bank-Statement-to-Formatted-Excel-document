...
public class PrintMessage {
	...
	public void printWelcomeMessage() {
		System.out.println("==================================================\n");
		System.out.println("Welcome to Gabriel's Bank Statement Converter version:"+version+"\n");
		System.out.println("==================================================\n");
	...
	public void printHelp() {
		System.out.println("\n\nPlease see the attached manual, this should answer all questions related to your issues.");
