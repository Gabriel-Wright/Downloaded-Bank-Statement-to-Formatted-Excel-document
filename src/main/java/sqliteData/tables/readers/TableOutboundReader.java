...
/**
 * The TableOutboundReader class extends the TableOutbound class and provides
 * additional functionality to read and extract Outbound transactions from the
 * Outbound table of an SQLite database. It includes methods to extract Outbound
 ...
 * 
 * The TableOutboundReader class is designed to be used in conjunction with the
 * TableCategoryReader class and TableUtils class to provide comprehensive
 * transaction reading and extraction functionality.
 * 
 * Note: The TableOutboundReader class assumes that the necessary tables and
 * connections have been set up prior to use.
 * 
 * Note: The TableOutboundReader class inherits methods from the TableOutbound
...
public class TableOutboundReader extends TableOutbound {
	 ...
	 */
	/**
	 * Constructs a new TableOutbound object with the specified TableOutbound and
	 * TableCategoryReader objects.
	 *
	 * @param tO  - the TableOutbound object associated with the reader
	...
	public TableOutboundReader(TableOutbound tO, TableCategoryReader tCR, TableUtils util) {
		super(tO.getDB());
		this.tCR = tCR;
		this.util = util;
	}
	...
	/**
	 * Extracts an array of outbound transactions within the specified date range and
	 * category.
	 *
	 * @param startDate - the start date of the date range
	 * @param endDate   - the end date of the date range
	 * @param category  - the category for filtering the transactions
	 * @return an array of Transaction objects representing the extracted outbound
	...
	/**
	 * Extracts a map of outbound transactions within the specified date range and
	...
	public Map<Integer, List<Transaction>> extractOutboundTransactionMap(String startDate, String endDate,
			String category) {
		// Generate queryString from TableUtils
		if (!tCR.checkCategoryOption(category)) {
			System.out.println("No categories of that type found");
